    ...
    <footer class="bg-navy text-white pt-16 pb-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                ...
                <div class="col-span-1 md:col-span-1">
                    <div class="flex items-center gap-2 mb-6">
                        ...
                        <span class="text-xl font-bold tracking-tight">LMS<span class="text-blue-400">Core</span></span>
                    </div>
                    ...
                    <div class="flex gap-4">
                        <a href="#" class="p-2 bg-navy-light rounded-lg hover:bg-white hover:text-navy transition-all">
            ...
            <div class="text-center text-blue-100/50 text-xs">
                &copy; <?php echo date('Y'); ?> LMS Core. All rights reserved. Created with <span class="text-red-400">&hearts;</span> for excellence.
            </div>
        </div>
    </footer>
