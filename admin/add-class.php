...
<div class="max-w-4xl mx-auto px-4 pb-20">
    <div class="bg-white rounded-[2.5rem] shadow-2xl border border-gray-100 overflow-hidden">
        ...
        <div class="h-32 bg-navy relative overflow-hidden flex items-center px-10">
            <h2 class="text-2xl font-black text-white italic tracking-tight relative z-10">Course Information Details</h2>
        ...
        <form action="#" method="POST" class="p-10 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="space-y-2">
                    <label class="block text-[10px] font-black uppercase text-navy tracking-widest italic ml-1">Class Title</label>
                ...
                <div class="space-y-2">
                    <label class="block text-[10px] font-black uppercase text-navy tracking-widest italic ml-1">Select Instructor</label>
            ...
            <!-- Description -->
            <div class="space-y-2">
                <label class="block text-[10px] font-black uppercase text-navy tracking-widest italic ml-1">Course Description</label>
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="space-y-2">
                    <label class="block text-[10px] font-black uppercase text-navy tracking-widest italic ml-1">Date</label>
                ...
                <div class="space-y-2">
                    <label class="block text-[10px] font-black uppercase text-navy tracking-widest italic ml-1">Start Time</label>
                ...
                <div class="space-y-2">
                    <label class="block text-[10px] font-black uppercase text-navy tracking-widest italic ml-1">Duration</label>
                ...
                <div class="space-y-2">
                    <label class="block text-[10px] font-black uppercase text-navy tracking-widest italic ml-1">Price ($)</label>
            ...
            <div class="p-8 border-4 border-dashed border-gray-100 rounded-[2rem] bg-gray-50/30 group hover:border-navy/10 transition-colors">
                <div class="flex flex-col items-center justify-center text-center">
                    ...
                    <label class="cursor-pointer">
                        ...
                        <p class="text-sm font-black text-navy uppercase italic tracking-widest mb-1">Upload Course Assets (ZIP)</p>
            ...
            <div class="flex flex-col sm:flex-row gap-4 pt-6">
                <button type="submit" class="flex-1 bg-navy text-white py-5 rounded-[2rem] font-black uppercase italic tracking-[0.2em] shadow-2xl shadow-navy/40 hover:bg-navy-dark active:scale-[0.98] transition-all flex items-center justify-center gap-3">
                    <i data-lucide="zap" class="w-5 h-5"></i>
                    Publish Course Now
                </button>
                <button type="button" class="px-10 bg-white text-gray-400 border-2 border-gray-100 py-5 rounded-[2rem] font-black uppercase italic tracking-widest hover:border-red-400 hover:text-red-400 transition-all">
                    Cancel
                </button>
            </div>
        </form>
