...
<div class="max-w-7xl mx-auto px-4">
    ...
    <div class="flex gap-4 mb-8 overflow-x-auto pb-4 scrollbar-hide">
        <div class="bg-navy text-white px-6 py-4 rounded-3xl flex items-center gap-4 shrink-0 shadow-xl shadow-navy/20">
            <span class="text-3xl font-black italic"><?php echo $new_requests; ?></span>
        ...
        <div class="bg-white border border-gray-100 px-6 py-4 rounded-3xl flex items-center gap-4 shrink-0 shadow-sm">
            <span class="text-3xl font-black italic text-navy"><?php echo $total_approved; ?></span>
            <span class="text-[10px] uppercase font-bold tracking-widest leading-none text-gray-400">Total <br> Approved</span>
        </div>
        <div class="bg-white border border-gray-100 px-6 py-4 rounded-3xl flex items-center gap-4 shrink-0 shadow-sm">
            <span class="text-3xl font-black italic text-red-500"><?php echo $rejected_requests; ?></span>
            <span class="text-[10px] uppercase font-bold tracking-widest leading-none text-gray-400">Rejected <br> Requests</span>
        </div>
    </div>

    <?php if (isset($_GET['updated'])): ?>
        <div class="mb-6 p-4 bg-green-50 border-l-4 border-green-500 text-green-700 rounded-xl font-bold italic text-sm">
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-50">
                    <?php if (empty($registrations)): ?>
                        <tr>
                            <td colspan="5" class="px-6 py-10 text-center text-gray-400 italic font-bold">No enrollment requests found.</td>
                        </tr>
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            <td class="px-6 py-5">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="font-bold text-navy italic"><?php echo htmlspecialchars($reg['name']); ?></p>
                            ...
                            <td class="px-6 py-5">
                                ...
                                <span class="text-[10px] text-gray-400 font-black uppercase italic">Applied: <?php echo date('M d, Y', strtotime($reg['created_at'])); ?></span>
                            </td>
                            ...
                            <td class="px-6 py-5">
                                ...
                                ?>
                                <span class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-[10px] font-black uppercase italic border <?php echo $status_classes[$reg['status']]; ?>">
                            ...
                            <td class="px-6 py-5">
                                <div class="flex items-center justify-center gap-2">
                                    <?php if ($reg['status'] !== 'approved'): ?>
                                        <a href="registrations.php?action=approve&id=<?php echo $reg['id']; ?>" class="bg-green-500 text-white px-4 py-2 rounded-xl text-[10px] font-black uppercase italic shadow-lg shadow-green-500/20 hover:scale-105 transition-transform active:scale-95">Approve</a>
                                    <?php endif; ?>
                                    <?php if ($reg['status'] !== 'rejected'): ?>
                                        <a href="registrations.php?action=reject&id=<?php echo $reg['id']; ?>" class="bg-red-500 text-white px-4 py-2 rounded-xl text-[10px] font-black uppercase italic shadow-lg shadow-red-500/20 hover:scale-105 transition-transform active:scale-95">Reject</a>
                                    <?php endif; ?>
                                </div>
                            </td>
                        </tr>
